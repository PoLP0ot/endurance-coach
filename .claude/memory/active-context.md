...
- **Next:** activity detail reskin · More-sheet · then Phase 4 new screens (Signals/Explore, conversational onboarding, /pricing page, goal-variant dashboards, push-to-watch) · Phase 5 real integrations (Garmin/OpenAI/Paddle/Resend/Mapbox) · Phase 6 QA sweep.
